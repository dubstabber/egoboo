...
- [EngineContext ::get() state 2026-06](enginecontext_get_state_2026_06.md) — 712 total ::get() calls; 15 services already in EngineContext; top 5 unrouted singletons (Renderer 87, video_buffer_manager 12, GraphicsSystemNew 9, TLT 5, Console 4)
