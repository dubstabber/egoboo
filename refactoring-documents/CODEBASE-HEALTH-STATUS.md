...
code, the 8,000-line monoliths are gone, and behavior is now pinned by 972
...
| ctest cases | 972 | `ctest --test-dir build -N` |
| ctest baseline | 972 / 972 | Last recorded green baseline in the pass log; use `ctest -j20 --output-on-failure` |
