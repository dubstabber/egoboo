...
code, the 8,000-line monoliths are gone, and behavior is now pinned by 968
...
| ctest cases | 968 | `ctest --test-dir build -N` |
| ctest baseline | 968 / 968 | Last recorded green baseline in the pass log; use `ctest -j20 --output-on-failure` |
