...
code, the 8,000-line monoliths are gone, and behavior is now pinned by 977
...
| ctest cases | 977 | `ctest --test-dir build -N` |
| ctest baseline | 977 / 977 | Last recorded green baseline in the pass log; use `ctest -j20 --output-on-failure` |
