...
- Keep `AudioSystem::get()`, `PerkHandler::get()`, `ImageManager::get()`, `ParticleHandler::get()`, `ProfileSystem::get()`, and `Log::get()` as subsystem-local bootstrap or lifecycle seams until a DI container is defined.
- Next separate pass: `egoboo_config_t`.
