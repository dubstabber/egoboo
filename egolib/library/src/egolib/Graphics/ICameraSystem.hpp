...
/// @file egolib/Graphics/ICameraSystem.hpp
/// @brief Lower-layer camera-system service interface + active-instance accessor seam.
...
public:
    ...
    virtual bool isTileInMainCameraRenderList(const Index1D& tile) const = 0;
};
