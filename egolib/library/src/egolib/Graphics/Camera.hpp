...
public:
	 ...
	 *  the view matrix.
	 */
	virtual const Ego::Matrix4f4f& getViewMatrix() const = 0;
	 ...
	 */
	virtual const Ego::Matrix4f4f& getProjectionMatrix() const = 0;
...
public:
	 ...
	 */
	virtual const Ego::Vector3f& getUp() const = 0;
	 ...
	 */
	virtual const Ego::Vector3f& getRight() const = 0;
	 ...
	 */
	virtual const Ego::Vector3f& getForward() const = 0;
