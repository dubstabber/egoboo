...
public:
    ...
    /// @return the location
    idlib::hll::location get_location() const
    {
        return idlib::hll::location(get_file_name(), get_line_number());
    }
...
private:
	...
	{
		return idlib::parsing_expression::sym<ExtendedSymbolType>(c);
	}
...
public:
    ...
    {
        static const auto p = idlib::parsing_expression::whitespace<ExtendedSymbolType>();
        return p;
    }

    static decltype(auto) NEW_LINE()
    {
        static const auto p = idlib::parsing_expression::newline<ExtendedSymbolType>();
        return p;
    }

    static decltype(auto) ALPHA()
    {
        static const auto p = idlib::parsing_expression::alpha<ExtendedSymbolType>();
        return p;
    }

    static decltype(auto) DIGIT()
    {
        static const auto p = idlib::parsing_expression::digit<ExtendedSymbolType>();
        return p;
    }

    static decltype(auto) END_OF_INPUT()
    {
        static const auto p = idlib::parsing_expression::end_of_input<ExtendedSymbolType>();
        return p;
    }
