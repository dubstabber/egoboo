...
egoboo_config_t::egoboo_config_t() :
    ...
    graphic_textureFilter_minFilter(idlib::texture_filter_method::linear, "graphic.textureFilter.minFilter", "texture filter used for minification",
    {
        { "none", idlib::texture_filter_method::none },
        { "nearest", idlib::texture_filter_method::nearest },
        { "linear", idlib::texture_filter_method::linear },
    }),
    graphic_textureFilter_magFilter(idlib::texture_filter_method::linear, "graphic.textureFilter.magFilter", "texture filter used for magnification",
    {
        { "none", idlib::texture_filter_method::none },
        { "nearest", idlib::texture_filter_method::nearest },
        { "linear", idlib::texture_filter_method::linear },
    }),
    graphic_textureFilter_mipMapFilter(idlib::texture_filter_method::linear, "graphic.textureFilter.mipMapFilter", "filter used for mip map selection",
    {
        { "none", idlib::texture_filter_method::none },
        { "nearest", idlib::texture_filter_method::nearest },
        { "linear", idlib::texture_filter_method::linear }
