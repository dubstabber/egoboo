...
struct water_instance_layer_t
{
    ...
    Ego::Vector2f _dist;         ///< some indication of "how far away" the layer is if it is an overlay

    Ego::Vector2f _tx;           ///< Coordinates of texture
    ...
    Ego::Vector2f _tx_add;            ///< Texture movement
