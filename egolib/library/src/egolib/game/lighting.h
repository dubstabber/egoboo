...
/// @file egolib/game/lighting.h

#pragma once

#include "egolib/Math/_Include.hpp"  // Vector3f, Matrix4f4f, AxisAlignedBox3f
 ...
 */
void lighting_vector_evaluate( const LightingVector& lvec, const Ego::Vector3f& nrm, float& direct, float& amb);
...
struct lighting_cache_base_t
{
	...
	static float evaluate(const lighting_cache_base_t& self, const Ego::Vector3f& nrm, float& amb);
};
...
struct lighting_cache_t
{
	...
	static void lighting_project_cache(lighting_cache_t& dst, const lighting_cache_t& src, const Ego::Matrix4f4f& mat);
	...
	static float lighting_evaluate_cache(const lighting_cache_t& src, const Ego::Vector3f& nrm, const float z, const Ego::AxisAlignedBox3f& bbox, float *light_amb, float *light_dir);
...
struct dynalight_data_t
{
	...
	Ego::Vector3f pos;           ///< Light position
