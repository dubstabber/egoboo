...
/// @file egolib/game/script_compile.h
...
private:
    ...
    void emit(Ego::Script::PDLTokenKind kind, const idlib::hll::location& start, const idlib::hll::location& end);
    void emit(Ego::Script::PDLTokenKind kind, const idlib::hll::location& start, const idlib::hll::location& end,
...
public:
    line_scanner_state_t(Ego::Script::Buffer *inputBuffer, const idlib::hll::location& location);
...
public:
    idlib::hll::location getLocation() const;
