...
/// @file egolib/game/GameStates/SelectModuleState.cpp
	...
	_selectedPlayerList(playersToLoad)
{
    ...
    _backButton->setPosition({ _moduleSelector->getX() + _moduleSelector->getWidth() + 20, _chooseModule->getY() + 50 });
    _backButton->setSize({ 200, 30 });
