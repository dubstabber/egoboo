...
// script_compile_lexer.c TU (split off 2026-06-12). The struct itself is declared in
// script_compile.h, so call-sites in this file see the full type via that header.
//--------------------------------------------------------------------------------------------
