...
protected:
    ...
    idlib::hll::qualified_name m_qualifiedName;
...
public:
    ...
    ConfigEntry(const idlib::hll::qualified_name& qualifiedName, const std::string& value);
    ...
    const idlib::hll::qualified_name& getQualifiedName() const;
...
public:
    ...
    using MapTy = std::unordered_map<idlib::hll::qualified_name, std::shared_ptr<ConfigEntry>>;
     ...
     */
    std::unordered_map<idlib::hll::qualified_name,std::shared_ptr<ConfigEntry>> _map;
...
public:
     ...
     */
    bool set(const idlib::hll::qualified_name& qn, const std::string& v)
    {
        try
        {
     ...
     */
    bool get(const idlib::hll::qualified_name& qn, std::string& v) const
    {
...
protected:
     ...
     */
    std::unique_ptr<idlib::hll::qualified_name> _currentQualifiedName;
    /**
     * @brief
