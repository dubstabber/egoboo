...
private:
    ...
    Ego::Vector3f m_oldVelocity;
    /// @brief The current velocity of the entity.
    Ego::Vector3f m_velocity;
public:
    PhysicsData();
    ...
    const Ego::Vector3f& getOldVelocity() const;

    /// @brief Set the old velocity.
    /// @param oldVelocity the old velocity
    void setOldVelocity(const Ego::Vector3f& oldVelocity);
     
    /// @brief Get the velocity.
    /// @return the velocity
    const Ego::Vector3f& getVelocity() const;
