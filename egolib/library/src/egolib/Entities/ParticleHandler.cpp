...
std::shared_ptr<Ego::Particle> ParticleHandler::spawnGlobalParticle(const Ego::Vector3f& spawnPos, const Facing& spawnFacing,
...
std::shared_ptr<Ego::Particle> ParticleHandler::spawnParticle(const Ego::Vector3f& spawnPos, const Facing& spawnFacing, const ObjectProfileRef spawnProfile,
